...
linear_button.grid(row=len(boston.feature_names), column=0, columnspan=2, pady=10)
linear_result_label = ttk.Label(root, textvariable=linear_result)
linear_result_label.grid(row=len(boston.feature_names) + 1, column=0, columnspan=2, pady=10)

nn_button = ttk.Button(root, text="Neural Network Predict", command=predict_neural_network)
nn_button.grid(row=len(boston.feature_names) + 2, column=0, columnspan=2, pady=10)
nn_result_label = ttk.Label(root, textvariable=nn_result)
nn_result_label.grid(row=len(boston.feature_names) + 3, column=0, columnspan=2, pady=10)
